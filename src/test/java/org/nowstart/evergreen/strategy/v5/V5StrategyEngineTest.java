...
class V5StrategyEngineTest {
    ...
    private final V5StrategyOverrides params = V5StrategyOverrides.of(2, 1, 2.0, 3.0, 2, 0.6, 0.0);
    ...
    void evaluate_triggersTrailStopWithoutRegimeSell() {
        V5StrategyOverrides trailStopParams = V5StrategyOverrides.of(2, 3, 1.0, 1.0, 3, 0.99, 0.15);
        List<OhlcvCandle> candles = List.of(
                candle("2026-01-01T00:00:00Z", 100, 101, 99, 100),
